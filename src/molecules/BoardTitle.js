...
function BoardTitle(props) {
  ...
  return (
    <div className='flex flex-row flwx-nowrap relative justify-center flex-none items-center gap-1 lg:gap-2 px-2 leading-7 rounded transition hover:bg-white/20 focus:bg-white/40'>
